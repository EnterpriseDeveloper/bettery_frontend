...
export class EventStartComponent implements OnInit, OnChanges, OnDestroy {
  ...
  clickBoardName() {
    return this.validation
      ? "Invite friends to join as an Expert"
  ...
  modalAboutExpert() {
    ...
    modalRef.componentInstance.name =
      " Validate the event result, confirming what actually happened. For Social Media events, several Experts share a portion of the prize pool. For Friends events, the Expert has 24 hours to validate and gets a custom reward from the Host.";
  ...
  modalAboutPlayers() {
    ...
    modalRef.componentInstance.name =
      " Bet on the event outcome. The prize pool is taken from loser bets and shared to winning Players, Host, Experts, and other roles.";
  ...
  validatorsNeeded() {
    return this.eventData.validatorsAmount > 0
      ? this.eventData.validatorsAmount
      : "TBD after betting ends";
  }
