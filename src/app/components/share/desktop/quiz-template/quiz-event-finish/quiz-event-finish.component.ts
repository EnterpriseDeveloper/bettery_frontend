...
export class QuizEventFinishComponent implements OnInit {
  ...
  playersCount() {
    return this.question.parcipiantAnswers == undefined
      ? 0
      : this.question.parcipiantAnswers.length;
  }

  expertCount() {
    return this.question.validatorsAnswers == undefined
      ? 0
  ...
  getImg(i) {
    if (this.question.finalAnswer !== null) {
      if (this.myAnswers.answered) {
        if (
          this.question.finalAnswer == this.myAnswers.answer &&
          this.question.finalAnswer == i
        ) {
          return "win";
