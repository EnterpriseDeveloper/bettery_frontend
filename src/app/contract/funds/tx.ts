...
export const protobufPackage = "bettery.funds";
...
export const MsgCreateSwipeBetResponse = {
  ...
  decode(
    ...
    length?: number,
  ): MsgCreateSwipeBetResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreateSwipeBetResponse,
    } as MsgCreateSwipeBetResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgCreateSwipeBetResponse>,
  ): MsgCreateSwipeBetResponse {
    const message = {
      ...baseMsgCreateSwipeBetResponse,
    } as MsgCreateSwipeBetResponse;
...
const baseMsgCreateMintBet: object = {
  creator: "",
  reciever: "",
  amount: "",
  userId: 0,
...
export const MsgCreateMintBetResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number,
  ): MsgCreateMintBetResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreateMintBetResponse,
    } as MsgCreateMintBetResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgCreateMintBetResponse>,
  ): MsgCreateMintBetResponse {
    const message = {
      ...baseMsgCreateMintBetResponse,
    } as MsgCreateMintBetResponse;
...
export interface Msg {
  ...
  CreateSwipeBet(
    request: MsgCreateSwipeBet,
  ): Promise<MsgCreateSwipeBetResponse>;
...
export class MsgClientImpl implements Msg {
  ...
  CreateSwipeBet(
    ...
    return promise.then((data) =>
      MsgCreateSwipeBetResponse.decode(new Reader(data)),
    );
  }
  ...
  CreateMintBet(request: MsgCreateMintBet): Promise<MsgCreateMintBetResponse> {
    ...
    return promise.then((data) =>
      MsgCreateMintBetResponse.decode(new Reader(data)),
    );
  }
}
