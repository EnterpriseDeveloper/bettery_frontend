...
export const protobufPackage = "bettery.privateevents";
...
const baseMsgCreateValidPrivEvents: object = {
  creator: "",
  privId: 0,
  answer: "",
};
...
export const MsgCreateValidPrivEvents = {
  ...
  decode(
    ...
    const message = {
      ...baseMsgCreateValidPrivEvents,
    } as MsgCreateValidPrivEvents;
  ...
  fromPartial(
    object: DeepPartial<MsgCreateValidPrivEvents>,
  ): MsgCreateValidPrivEvents {
    const message = {
      ...baseMsgCreateValidPrivEvents,
    } as MsgCreateValidPrivEvents;
...
export const MsgCreateValidPrivEventsResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number,
  ): MsgCreateValidPrivEventsResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreateValidPrivEventsResponse,
    } as MsgCreateValidPrivEventsResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgCreateValidPrivEventsResponse>,
  ): MsgCreateValidPrivEventsResponse {
    const message = {
      ...baseMsgCreateValidPrivEventsResponse,
    } as MsgCreateValidPrivEventsResponse;
...
const baseMsgCreatePartPrivEvents: object = {
  creator: "",
  privId: 0,
  answer: "",
};
...
export const MsgCreatePartPrivEvents = {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgCreatePartPrivEvents {
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreatePartPrivEvents,
    } as MsgCreatePartPrivEvents;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgCreatePartPrivEvents>,
...
export const MsgCreatePartPrivEventsResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number,
  ): MsgCreatePartPrivEventsResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreatePartPrivEventsResponse,
    } as MsgCreatePartPrivEventsResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgCreatePartPrivEventsResponse>,
  ): MsgCreatePartPrivEventsResponse {
    const message = {
      ...baseMsgCreatePartPrivEventsResponse,
    } as MsgCreatePartPrivEventsResponse;
...
export const MsgCreateCreatePrivEvents = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreateCreatePrivEvents,
    } as MsgCreateCreatePrivEvents;
    message.answers = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  fromPartial(
    object: DeepPartial<MsgCreateCreatePrivEvents>,
  ): MsgCreateCreatePrivEvents {
    const message = {
      ...baseMsgCreateCreatePrivEvents,
    } as MsgCreateCreatePrivEvents;
...
export const MsgCreateCreatePrivEventsResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number,
  ): MsgCreateCreatePrivEventsResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreateCreatePrivEventsResponse,
    } as MsgCreateCreatePrivEventsResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgCreateCreatePrivEventsResponse>,
  ): MsgCreateCreatePrivEventsResponse {
    const message = {
      ...baseMsgCreateCreatePrivEventsResponse,
    } as MsgCreateCreatePrivEventsResponse;
...
export interface Msg {
  ...
  CreateValidPrivEvents(
    request: MsgCreateValidPrivEvents,
  ): Promise<MsgCreateValidPrivEventsResponse>;
  CreatePartPrivEvents(
    request: MsgCreatePartPrivEvents,
  ): Promise<MsgCreatePartPrivEventsResponse>;
  CreateCreatePrivEvents(
    request: MsgCreateCreatePrivEvents,
  ): Promise<MsgCreateCreatePrivEventsResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  CreateValidPrivEvents(
    ...
    const promise = this.rpc.request(
      "bettery.privateevents.Msg",
      "CreateValidPrivEvents",
      data,
    );
    return promise.then((data) =>
      MsgCreateValidPrivEventsResponse.decode(new Reader(data)),
    );
  }
  ...
  CreatePartPrivEvents(
    ...
    return promise.then((data) =>
      MsgCreatePartPrivEventsResponse.decode(new Reader(data)),
    );
  }
  ...
  CreateCreatePrivEvents(
    ...
    return promise.then((data) =>
      MsgCreateCreatePrivEventsResponse.decode(new Reader(data)),
    );
  }
}
