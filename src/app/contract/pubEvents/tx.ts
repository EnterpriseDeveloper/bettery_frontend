...
export const protobufPackage = "bettery.publicevents";
...
export const MsgCreateFihishPubEvent = {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgCreateFihishPubEvent {
    ...
    const message = {
      ...baseMsgCreateFihishPubEvent,
    } as MsgCreateFihishPubEvent;
  ...
  fromPartial(
    object: DeepPartial<MsgCreateFihishPubEvent>,
...
export const MsgCreateFihishPubEventResponse = {
  ...
  decode(
    ...
    length?: number,
  ): MsgCreateFihishPubEventResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreateFihishPubEventResponse,
    } as MsgCreateFihishPubEventResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgCreateFihishPubEventResponse>,
  ): MsgCreateFihishPubEventResponse {
    const message = {
      ...baseMsgCreateFihishPubEventResponse,
    } as MsgCreateFihishPubEventResponse;
...
export const MsgCreateValidPubEvents = {
  ...
  decode(input: Reader | Uint8Array, length?: number): MsgCreateValidPubEvents {
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreateValidPubEvents,
    } as MsgCreateValidPubEvents;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgCreateValidPubEvents>,
...
export const MsgCreateValidPubEventsResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number,
  ): MsgCreateValidPubEventsResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreateValidPubEventsResponse,
    } as MsgCreateValidPubEventsResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgCreateValidPubEventsResponse>,
  ): MsgCreateValidPubEventsResponse {
    const message = {
      ...baseMsgCreateValidPubEventsResponse,
    } as MsgCreateValidPubEventsResponse;
...
export const MsgCreatePartPubEvents = {
  ...
  fromPartial(
    object: DeepPartial<MsgCreatePartPubEvents>,
...
export const MsgCreatePartPubEventsResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number,
  ): MsgCreatePartPubEventsResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreatePartPubEventsResponse,
    } as MsgCreatePartPubEventsResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgCreatePartPubEventsResponse>,
  ): MsgCreatePartPubEventsResponse {
    const message = {
      ...baseMsgCreatePartPubEventsResponse,
    } as MsgCreatePartPubEventsResponse;
...
export const MsgCreateCreatePubEvents = {
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreateCreatePubEvents,
    } as MsgCreateCreatePubEvents;
    message.answers = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
  ...
  toJSON(message: MsgCreateCreatePubEvents): unknown {
    ...
    message.expertAmount !== undefined &&
      (obj.expertAmount = message.expertAmount);
    message.advisor !== undefined && (obj.advisor = message.advisor);
    return obj;
  },

  fromPartial(
    object: DeepPartial<MsgCreateCreatePubEvents>,
  ): MsgCreateCreatePubEvents {
    const message = {
      ...baseMsgCreateCreatePubEvents,
    } as MsgCreateCreatePubEvents;
...
export const MsgCreateCreatePubEventsResponse = {
  ...
  decode(
    input: Reader | Uint8Array,
    length?: number,
  ): MsgCreateCreatePubEventsResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input;
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseMsgCreateCreatePubEventsResponse,
    } as MsgCreateCreatePubEventsResponse;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromPartial(
    object: DeepPartial<MsgCreateCreatePubEventsResponse>,
  ): MsgCreateCreatePubEventsResponse {
    const message = {
      ...baseMsgCreateCreatePubEventsResponse,
    } as MsgCreateCreatePubEventsResponse;
...
export interface Msg {
  ...
  CreateFihishPubEvent(
    request: MsgCreateFihishPubEvent,
  ): Promise<MsgCreateFihishPubEventResponse>;
  CreateValidPubEvents(
    request: MsgCreateValidPubEvents,
  ): Promise<MsgCreateValidPubEventsResponse>;
  CreatePartPubEvents(
    request: MsgCreatePartPubEvents,
  ): Promise<MsgCreatePartPubEventsResponse>;
  CreateCreatePubEvents(
    request: MsgCreateCreatePubEvents,
  ): Promise<MsgCreateCreatePubEventsResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  CreateFihishPubEvent(
    ...
    const promise = this.rpc.request(
      "bettery.publicevents.Msg",
      "CreateFihishPubEvent",
      data,
    );
    return promise.then((data) =>
      MsgCreateFihishPubEventResponse.decode(new Reader(data)),
    );
  }
  ...
  CreateValidPubEvents(
    ...
    return promise.then((data) =>
      MsgCreateValidPubEventsResponse.decode(new Reader(data)),
    );
  }
  ...
  CreatePartPubEvents(
    ...
    return promise.then((data) =>
      MsgCreatePartPubEventsResponse.decode(new Reader(data)),
    );
  }
  ...
  CreateCreatePubEvents(
    ...
    return promise.then((data) =>
      MsgCreateCreatePubEventsResponse.decode(new Reader(data)),
    );
  }
}
